...
\SetKwBlock{Init}{init}{end}
\SetKwComment{Comment}{// }{}
\SetCommentSty{itshape}
\SetKwBlock{OnInput}{onInput}{end}
\SetKwBlock{OnMax}{}{end}
\SetKwBlock{OnTimeout}{onTimeout}{end}
\DontPrintSemicolon
\SetAlFnt{\small}
...
%%----------------------------------------
\title{Orchestration for Automatic Decentralization in Visually-defined IoT}
