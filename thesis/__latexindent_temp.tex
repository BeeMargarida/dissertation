...
To verify if the script delivery time is directly related with the payload size, this experiment was repeated 10 times and the script delivery time for each device was measured.
...
\begin{table}[ht]
    ...
    \begin{tabular}{ l  c  c  c  c }
        \toprule
        \textbf{Device 1} & \textbf{Device 2} & \textbf{Device 3} & \textbf{Device 4}\\
        \midrule
        304	& 304 & 304	& 297\\
        281	& 274 & 274	& 279\\
        300	& 325 & 328	& 311\\
        ...
        \bottomrule
    \end{tabular}
    \caption{Script delivery times grouped by device.}
    \label{tab:delivery_times_table}
\end{table}{}
