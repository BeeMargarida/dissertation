...
\begin{table*}[h]
    ...
    \begin{tabular}{ l  c  c  c  c  c  c  c }
        ...
        ViSiT~\cite{visit} & Several & Centralized & - & Cloud & High & Hybrid & \textbullet \\
...
\begin{table*}[!h]
    ...
    \begin{tabular}{ l  c  c  c  c  c }
        ...
        \textit{FogFlow} \& \textit{uFlow}~\cite{flow_based_programming_fog,fog_flow} & \textbullet & Limited\tnote{3} &  & \textbullet & Limited\tnote{3}\\
