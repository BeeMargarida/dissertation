...
\begin{table}[ht]
    ...
    \begin{tabular}{| l | r | r |}
        ...
        \hline
        Exclusion/Inclusion criteria (Introduction and Conclusion) & 26 & 39\\ %devify - 27
        \hline
    \end{tabular}
    }
...
After analyzing the 26 publications, we organized them by categories. \cite{survey_vpl_iot} is a survey and the remaining 25 were frameworks or tools.
...
\par The remaining 25 articles are frameworks or tools of visual programming applied to IoT. One of the tool is repeated in two papers, which showcases its evolution. The frameworks are:
...
\begin{table}[ht]
    ...
    \begin{tabular}{| c | c | c | c | c | c | c | c |}
        ...
        \hline
        Leotta et al. \cite{runtime_verification} \textcolor{red}{IS IT VALID} & * & Centralized\tnote{2} & - & Cloud and Edge\tnote{2} & - & Hybrid text and visual system\tnote{2} & \textbullet \\
        \hline
        ...
        \hline
        Ancona et al. \cite{runtime_monitoring} \textcolor{red}{IS IT VALID} & * & Centralized\tnote{2} & - & Cloud and Edge\tnote{2} & - & Hybrid text and visual system\tnote{2} & \textbullet \\
        %\hline
        %Devify \cite{devify} &  &  &  &  &  &  &  \\
        \hline
