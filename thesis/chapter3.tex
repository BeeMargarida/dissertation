...
The resulting categorization of the SLR results is depicted in \tableref{tab:slr_table_results}. Some key take-ways are easily observable, namely: (1)~most tools use a centralized architecture, (2)~the hybrid visual-textual programming paradigm is predominant, and (3)~most of the tools are web-based. The extended search findings and their categorization is presented in \tableref{tab:expanded_research_results}, following the same previously defined categories.
