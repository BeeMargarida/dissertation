...
\caption[Coordination between nodes in D-NR]{Coordination between nodes in D-NR~\cite{fog_at_the_edge}}
\end{figure}
...
\caption[Partition and assignment of parts of the flow]{Partition and assignment of parts of the flow \cite{flow_based_programming_fog}}
\end{figure}
...
\caption[\textit{FogFlow} architecture]{\textit{FogFlow} architecture~\cite{fog_flow}}
\end{figure}
...
\caption[\textit{FogFlow} high level model]{\textit{FogFlow} high level model~\cite{fog_flow_tool}}
\end{figure}
...
\caption[DDFlow architecture]{DDFlow architecture~\cite{ddflow}}
\end{figure}
