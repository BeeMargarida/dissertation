...
\begin{table}[ht]
    ...
    \begin{tabular}{| c | c | c | c | c | c | c | c |}
        ...
        Certainty & $\star$ $\star$ $\star$ $\star$ & $\star$ $\star$ $\star$ & $\star$ $\star$ $\star$ $\star$ $\star$ & $\star$ $\star$ $\star$  & $\star$ $\star$ $\star$ & $\star$ $\star$ $\star$ $\star$ & $\star$ $\star$ $\star$ $\star$ $\star$ \\
        \hline
...
\begin{description}
    \item [RQ1: What relevant VPLs applied to IoT exist?] Based on the results from Sections \ref{sec:slr_results} and \ref{tab:expanded_research_results}, there are 28 visual programming languages and/or environments applied to the Internet of Things paradigm.
    \item [RQ2: What is the scope of the tools found in RQ1?] The majority of tools found focus on various use cases, such as education, home automation and industry. These results can be consulted in Tables \ref{tab:slr_table_results} and \ref{tab:expanded_research_results} as well as in Section \ref{sec:result_analysis}.
    \item [RQ3: What is the architecture of the tools found in RQ1?] Centralized architectures are the dominant architectures in visual programming tools applied to IoT. 
