...
\begin{table}[ht]
    ...
    \begin{tabular}{| c | c | c | c | c | c | c | c |}
        ...
        \hline
        VIPLE \cite{viple} & Education & Centralized & - & Cloud & N/A & Hybrid text and visual system & \\
        \hline
        Smart Block \cite{smart_block} & Home Automation & Centralized & - & Cloud & N/A & Hybrid text and visual system & \textbullet \\
        \hline
        PWCT \cite{pwct} &  &  &  &  &  &  &  \\
        \hline
        DDF \cite{ddf} &  &  &  &  &  &  &  \\
