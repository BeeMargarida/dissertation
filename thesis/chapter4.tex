...
During the month of February, the Node-RED tool will be explored, as well as a solution to execute code in embedded devices. At the end of that month, a solution will be designed, which will be implemented in the next three months.

The implementation of the solution, separated in the four parts presented in the \emph{desiderata} in Section \ref{sec:desiderata}, will be executed in March and April. The testing and validation of the developed prototype will be done in May. 

Finally, June is solely assigned to writing the remainder of the dissertation, which was started in March.
