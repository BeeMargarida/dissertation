...
In the interest of validating whether or not the solution implemented achieves the \emph{desiderata} and solves the current issues, there will be developed test scenarios with the use of simulations. Each one of the test scenarios will be verified against the attributes mentioned in Section \ref{sec:stat_research_questions}, with the objective of proving the proposed hypothesis.
